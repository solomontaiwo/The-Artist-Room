            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <!-- Link di autenticazione la direttiva guest di blade mi dà la possibilità di far vedere la parte per accedere all'utente guest ovvero utente non autenticato-->
                        @guest
                        @if (Route::has('login'))
                        <li class="nav-item">
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 col-lg-6 mb-4">
                        <!-- Content -->
                        <br>
                        <h6 class="text-uppercase fw-bold" style="padding: 10px">The Artist Room</h6>
                    ...
                    <div class="col-md-6 col-lg-6 mb-4">
                        <br>
                        <!-- PARTE CONTATTI -->
                        <h6 class="text-uppercase fw-bold" style="padding: 10px">Contatti</h6>
                        <hr style="background-color: #b659ef; height: 2px;" />
                        ...
                        <!--icone prese da https://icons.getbootstrap.com/icons/telephone/-->
