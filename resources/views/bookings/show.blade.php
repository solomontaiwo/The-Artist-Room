...
<div class="container">
    ...
    <hr>
    <a href="{{ route('booking.edit', $booking->id) }}" class="btn btn-warning btn-sm me-2">Modifica prenotazione</a>
    <a href="{{ route('booking.index') }}" class="btn btn-primary btn-sm me-2">Vai alle tue prenotazioni</a>
